...
const features = [
    {
        ...
        description: "MAF operates as a pass-through middleware. We do not store request payloads unless explicitly configured for forensic logs. All data at rest is AES-256 encrypted.",
    ...
    },
    {
        ...
        description: "Deploy as a heavy-duty sidecar, a lightweight library, or an edge function. MAF supports Kubernetes, AWS Lambda, and Vercel Edge Middleware.",
