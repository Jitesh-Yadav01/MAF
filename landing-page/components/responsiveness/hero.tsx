...
type MafStatus = "Blocked" | "Challenge" | "Verified";
...
const generateThreat = (): ThreatEvent => {
    ...
    // Simulate WAF failures vs MAF success
    let waf_status: WafStatus = "Missed";
    let maf_status: MafStatus = "Blocked";
    
    // Randomize some outcomes
    const rand = Math.random();
    if (rand > 0.7) {
        waf_status = "False Positive";
        maf_status = "Verified"; // MAF correctly identifies valid traffic that WAF blocked
    } else if (rand > 0.5) {
         waf_status = "Log Only";
         maf_status = "Challenge"; // MAF steps up auth
    }
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            ...
            setStats(prev => ({
                ...
                blocked: prev.blocked + (newEvent.maf_status === "Blocked" ? 1 : 0),
