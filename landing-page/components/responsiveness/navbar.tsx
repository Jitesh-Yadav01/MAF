                ...
                <div className="flex h-14 md:h-18 items-center justify-between px-4 md:px-6">
                    <div className="flex items-center gap-6">
                        <Link href="/" className="flex items-center gap-2">
                            <Image src="/eaglelogoWhite.svg" alt="MAF Logo" width={54} height={54} className="h-8 w-auto md:h-12" />
                            <span className="font-jersey-20 text-3xl md:text-4xl font-bold text-white">MAF</span>
                        </Link>
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-1 overflow-y-auto overflow-x-hidden no-scrollbar flex-1 -mx-2 px-2">
                                ...
                                <Link href="https://github.com/Jitesh-Yadav01/maf" target="_blank" onClick={() => setIsMenuOpen(false)} className="px-2 mt-2">
