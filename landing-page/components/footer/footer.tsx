            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <Link href="#" className="text-sm text-muted-foreground hover:text-foreground">About MAF</Link>
                        <Link href="#" className="text-sm text-muted-foreground hover:text-foreground">Roadmap</Link>
                        <Link href="https://github.com/jrdevadattan/maf" className="text-sm text-muted-foreground hover:text-foreground">GitHub</Link>
