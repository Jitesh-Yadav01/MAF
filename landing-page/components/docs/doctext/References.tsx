        ...
        <DocsSection id="references" title="Research References">
            ...
            <div className="grid gap-4">
                <ReferenceCard
                    ...
                    description="This paper reveals over 1200 unique evasion techniques that bypass top WAFs (Cloudflare, AWS, Azure) by exploiting parsing mismatches between the firewall and the application backend. MAF's application-layer design inherently eliminates this entire class of vulnerability."
