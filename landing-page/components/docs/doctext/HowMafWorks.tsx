        ...
        <DocsSection id="how-maf-works" title="How MAF Works">
            ...
            <div className="my-6 p-4 border border-yellow-500/20 bg-yellow-500/10 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                    ...
                    <br/><br/>
                    <strong>MAF runs <em>inside</em> or <em>beside</em> your application logic</strong>, ensuring it sees exactly what your application sees, eliminating this gap.
                </p>
            </div>
