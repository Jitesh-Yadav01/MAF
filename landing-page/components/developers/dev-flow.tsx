...
export function DevFlow() {
  const steps = [
    ...
    { name: "MAF Middleware", icon: ShieldAlert, color: "text-blue-500", bg: "bg-blue-500/10", border: "border-blue-500/20", glow: true },
  ...
  return (
    <section className="px-6 py-32 bg-black relative border-y border-white/5 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl relative z-10 text-center">
        <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-white mb-20">How MAF Works</h2>
