        ...
        <div className="space-y-12">
            ...
            <DocsSection id="architecture-overview" title="Architecture Overview">
                ...
                <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
                    ...
                    <li><strong>Audit Layer:</strong> <span className="text-foreground font-mono text-xs bg-muted px-1 py-0.5 rounded">MongoDB</span> stores detailed logs for every request. An optional <strong>Blockchain Anchor</strong> service provides immutable proof of logs for compliance.</li>
                </ol>
